...
public:
    ...
    virtual void set_sigmaS(const double newValue){sigmaS=newValue;};
    virtual void set_sigmaR(const double newValue){sigmaR=newValue;};
    virtual void set_minRegion(const double newValue){minRegion=newValue;};
    virtual void set_gradWindRad(const double newValue){gradWindRad=newValue;};
    virtual void set_threshold(const double newValue){newValue <=1 ? threshold=newValue: threshold=1; if (threshold <0) threshold =0;};
    virtual void set_mixture(const double newValue){newValue <=1 ? mixture=newValue: mixture=1; if (mixture<0 ) mixture=0;};
