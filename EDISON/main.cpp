...
/conf
for module configuration, according to EDISONsegmentation.thrift definition file
...
\author Alexandre Bernardino, Elena Ceseracciu (improved module version)
...
int main(int argc, char *argv[]) {
    ...
    ResourceFinder rf;
    rf.setVerbose(true);
    rf.setDefaultContext("edisonSegm/conf");
    rf.setDefaultConfigFile("config.ini");
    rf.configure("ICUB_ROOT",argc,argv);

    EdisonSegmModule mod;
