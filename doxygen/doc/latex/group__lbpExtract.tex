...
\begin{DoxyItemize}
\item /lbp\+Extract/rpc\+:i \mbox{[}rpc-\/server\mbox{]}\+: service port . This service is described in \mbox{\hyperlink{classlbpExtract__IDLServer}{lbp\+Extract\+\_\+\+IDLServer}} (lbp\+Extract.\+thrift) 
\end{DoxyItemize}