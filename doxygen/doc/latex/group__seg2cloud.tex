...
\item -- color\+\_\+distance\+: Blob distance threshold for 2D flood (RGB intensity) 
...
\begin{DoxyItemize}
\item /seg2cloud/rpc\+:i \mbox{[}rpc\mbox{]} \mbox{[}default carrier\+:tcp\mbox{]}\+: Takes the following RPC commands
\begin{DoxyEnumerate}
...
\item /seg2cloud/\+SFM\+:rpc \mbox{[}rpc\mbox{]} \mbox{[}default carrier\+:tcp\mbox{]}\+: rpc port to communicate with the SFM module, to receive disp data and the 3D points.
